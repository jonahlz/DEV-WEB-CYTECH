...
<nav>
  ...
  <ul class="nav-links">
    ...
    <li>
      <a href="/Lumihome/index.php?page=niveaux"
         class="<?= $page === 'niveaux' ? 'active' : '' ?>"><?= $emoji_nav ?> Niveaux</a>
    </li>
    <li>
  ...
  <div class="nav-right">
    <?php if (isLoggedIn()): ?>
      ...
      <span class="badge-role" style="background:rgba(34,197,94,.08);color:#22c55e;border-color:rgba(34,197,94,.2)">
        <?= $emoji_nav ?? '🌱' ?> <?= ucfirst($_SESSION['niveau'] ?? 'debutant') ?>
      </span>
