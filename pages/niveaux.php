...
<div class="page">
    ...
    ">
      ...
      <div style="margin-top:.75rem;padding-top:.65rem;border-top:1px solid var(--border);
        ...
        $acces = match($nv['niveau']) {
            'debutant'      => '💡 Allumer / Éteindre · Max 3 lumières · +0,25 pt connexion · +0,50 pt toggle',
            'intermediaire' => '💡 Allumer / Éteindre · Réglage intensité · Max 5 lumières · +0,50 pt/action',
            'avance'        => '🎨 + Changement de couleur · Max 8 lumières · +0,50 pt/action',
            'expert'        => '👑 Toutes les fonctionnalités · Lumières illimitées (99)',
            default         => ''
        };
        echo escape($acces);
        ?>
  ...
  <div class="card" style="margin-bottom:2rem">
    <div style="margin-bottom:1rem;padding:.6rem .9rem;background:rgba(245,200,66,.06);
                border:1px solid rgba(245,200,66,.18);border-radius:8px;
                font-size:.8rem;color:var(--accent)">
      ⏱️ <strong>Règle anti-spam :</strong> chaque type d'action doit être espacé de
      <strong>3 minutes minimum</strong> pour rapporter des points. L'action s'exécute toujours,
      mais les points ne sont accordés qu'une fois le cooldown écoulé.
    </div>
    <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(210px,1fr));gap:1.25rem">
      ...
      <div>
        ...
        <div style="font-weight:600;font-size:.9rem;margin-bottom:.2rem">Connexion</div>
        <div style="display:inline-block;font-size:.72rem;font-weight:700;padding:.15rem .5rem;
                    border-radius:20px;background:rgba(245,200,66,.12);color:var(--accent);
                    margin-bottom:.4rem">+0,25 pt</div>
        <div style="font-size:.78rem;color:var(--muted);line-height:1.5">
          Se connecter à la plateforme. Une seule fois toutes les 3 min.
        </div>
      </div>

      <div>
        <div style="font-size:1.4rem;margin-bottom:.4rem">💡</div>
        <div style="font-weight:600;font-size:.9rem;margin-bottom:.2rem">Allumer / Éteindre</div>
        <div style="display:inline-block;font-size:.72rem;font-weight:700;padding:.15rem .5rem;
                    border-radius:20px;background:rgba(245,200,66,.12);color:var(--accent);
                    margin-bottom:.4rem">+0,50 pt · Débutant+</div>
        <div style="font-size:.78rem;color:var(--muted);line-height:1.5">
          Changer l'état d'une lumière (allumer ou éteindre). Cooldown 3 min.
        </div>
      </div>

      <div style="opacity:<?= in_array($user['niveau'],['intermediaire','avance','expert'])?1:.45 ?>">
        <div style="font-size:1.4rem;margin-bottom:.4rem">🔆</div>
        <div style="font-weight:600;font-size:.9rem;margin-bottom:.2rem">Réglage d'intensité</div>
        <div style="display:inline-block;font-size:.72rem;font-weight:700;padding:.15rem .5rem;
                    border-radius:20px;background:rgba(59,130,246,.12);color:#3b82f6;
                    margin-bottom:.4rem">+0,50 pt · Intermédiaire+</div>
        <div style="font-size:.78rem;color:var(--muted);line-height:1.5">
          Modifier la luminosité d'une lumière allumée. Cooldown 3 min.
        </div>
      </div>

      <div style="opacity:<?= in_array($user['niveau'],['avance','expert'])?1:.45 ?>">
        <div style="font-size:1.4rem;margin-bottom:.4rem">🎨</div>
        <div style="font-weight:600;font-size:.9rem;margin-bottom:.2rem">Changement de couleur</div>
        <div style="display:inline-block;font-size:.72rem;font-weight:700;padding:.15rem .5rem;
                    border-radius:20px;background:rgba(245,200,66,.12);color:var(--accent);
                    margin-bottom:.4rem">+0,50 pt · Avancé+</div>
        <div style="font-size:.78rem;color:var(--muted);line-height:1.5">
          Changer la couleur d'une lumière (valeur différente requise). Cooldown 3 min.
        </div>
      </div>

      <div>
        <div style="font-size:1.4rem;margin-bottom:.4rem">➕</div>
        <div style="font-weight:600;font-size:.9rem;margin-bottom:.2rem">Ajouter une lumière</div>
        <div style="display:inline-block;font-size:.72rem;font-weight:700;padding:.15rem .5rem;
                    border-radius:20px;background:rgba(34,197,94,.12);color:#22c55e;
                    margin-bottom:.4rem">+1,00 pt · Tous niveaux</div>
        <div style="font-size:.78rem;color:var(--muted);line-height:1.5">
          Enregistrer un nouvel appareil (dans la limite du niveau). Cooldown 3 min.
        </div>
      </div>

      <div>
        <div style="font-size:1.4rem;margin-bottom:.4rem">🗑️</div>
        <div style="font-weight:600;font-size:.9rem;margin-bottom:.2rem">Supprimer une lumière</div>
        <div style="display:inline-block;font-size:.72rem;font-weight:700;padding:.15rem .5rem;
                    border-radius:20px;background:rgba(245,200,66,.12);color:var(--accent);
                    margin-bottom:.4rem">+0,25 pt · Tous niveaux</div>
        <div style="font-size:.78rem;color:var(--muted);line-height:1.5">
          Retirer un appareil de la plateforme. Cooldown 3 min.
        </div>
      </div>
